...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/configuration.input') 
C
        READ(2,5)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/sensor.input') 
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/environment.input')
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/ground.input')
C
       READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/trunk_and_gross_canopy.input')
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/leaf.input')
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/needle.input')
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/branch_primary.input')
C
        READ(2,10)
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/branch_secondary.input')
C
        READ(2,10)
...
C
        IF(J.EQ.1) THEN
           OPEN(UNIT=2,FILE='../input_dir/dielectric_trunk_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 110 I=1,NUMBER
...
C
        ELSE IF(J.EQ.2) THEN
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_branch1_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 120 I=1,NUMBER
...
C
        ELSE IF(J.EQ.3) THEN
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_branch2_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 130 I=1,NUMBER
...
C
        ELSE IF(J.EQ.4) THEN
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_leaf_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 140 I=1,NUMBER
...
C
        ELSE IF(J.EQ.5) THEN
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_needle_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 150 I=1,NUMBER
...
C
        ELSE IF(J.EQ.6) THEN
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_ground_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 160 I=1,NUMBER
...
C
         OPEN(UNIT=2,FILE='../input_dir/dielectric_snow_table.input')
           READ(2,5)
           READ(2,20) NUMBER
           READ(2,25)
           DO 170 I=1,NUMBER
...
C***********************************************************************
C
        OPEN(UNIT=2,FILE='../input_dir/parameter_nesting.input')
C
        READ(2,10)
...
C
        IF(.NOT.TABLE_OPEN)THEN
            OPEN(UNIT=3,FILE='../input_dir/parameter_value_table.input')
C           skip 5 lines (file header)
            READ(3,25)
            READ(3,25)
            READ(3,25)
            READ(3,25)
        ...
        ENDIF
C
C       skip 3 lines (parameter header)
        READ(3,25)
        READ(3,25)
        READ(3,25)
        READ(3,20) NUMBER
C
        ...
        DO 100 I=1,NUMBER
            READ(3,30) VECTOR(I)
            print *,'reading: ',vector(i)
100     CONTINUE
C       skip 1 line (parameter trailer)
        READ(3,25)
...
C
        IF(J.EQ.1) THEN
            SUM = 0.0
            OPEN(UNIT=2,FILE='../input_dir/histogram_trunk_diam.input')
