...
C       = WAVE NUMBER (1/M)
C
C   P_BRANCH(4,4,4) = Four 4x4 Phase Matrices of the branches
C   P_BRANCH(L,K,1) = Phase Matrix of ground-direct term
C   P_BRANCH(L,K,2) = Phase Matrix of crown-ground term
C   P_BRANCH(L,K,3) = Phase Matrix of ground-crown term
C   P_BRANCH(L,K,4) = Phase Matrix of direct-crown term
C
...
C                      direction
C
C   M_BRANCH_P(2,2) = 2x2 complex M matrix in positive-going direction
C                      -- AVERAGE SCATTEING MATRIX TIMES 2*PI*N/k0
C   M_BRANCH_M(2,2) = 2x2 complex M matrix in negative-going direction
C
...
C
C   EXP_KAPPA_BR_P(4,4) = positive-going attenuation of the branches
C                         alone
C   EXP_KAPPA_BR_M(4,4) = negative-going attenuation of the branches
C                         alone
C
...
C
C   PDF_BR(THETAC) = real-valued P.D.F. function describing the
