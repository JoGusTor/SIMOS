...
c
        ...
        real P_CROWN(4,4,4),P_NEEDLE(4,4),P_LEAF(4,4),P_BRANCH(4,4)
        real P_BRANCH_2(4,4)
...
C
     ...
     &          I_PDF_NDL_SIZE, I_PDF_TRUNK_SIZE
...
C
        CHARACTER*30 C_PDF_NDL,C_PDF_BR1,C_PDF_BR2,C_PDF_LF,C_PDF_TR
        CHARACTER*30 C_PDF_NDL_SZ,C_PDF_BR1_SZ,C_PDF_BR2_SZ,C_PDF_LF_SZ,
     &               C_PDF_TR_SZ
        character*30 c_surf
C
        INTEGER ILOW
...
C
         open(unit=8,file='../output_dir/forest_sigma_like.out')
         open(unit=7,file='../output_dir/forest_sigma_cross.out')
         open(unit=11,file='../output_dir/forest_trans.out')
         open(unit=12,file='../output_dir/forest_phase_terms.out')
         open(unit=13,file='../output_dir/forest_phase_crown.out')
         open(unit=14,file='../output_dir/forest_phase_trunk.out')

         if(l_pol)open(unit=15,file='../output_dir/polarimetric.out')
         if(l_phase)
     &       open(unit=16,file='../output_dir/forest_phase_mats.out')
         if(l_kappa)
     &       open(unit=17,file='../output_dir/forest_kappa_mats.out')
         if(l_trans)
     &       open(unit=18,file='../output_dir/forest_trans_mats.out')

         open(unit=19,file='../output_dir/mimics2.data')
c
            numfamily = 0
c
c
            ...
            write(19,72)
c
            write(8,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
            write(7,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
            write(11,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
            write(12,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
            write(13,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
            write(14,100) LOG_CONSTITUENT(1), LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
          if(l_pol)write(15,100) LOG_CONSTITUENT(1),LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
          if(l_phase)write(16,100)LOG_CONSTITUENT(1),LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
          if(l_kappa)write(17,100)LOG_CONSTITUENT(1),LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
          if(l_trans)write(18,100)LOG_CONSTITUENT(1),LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
          write(19,100)LOG_CONSTITUENT(1),LOG_CONSTITUENT(2),
     &                   LOG_CONSTITUENT(3), LOG_CONSTITUENT(4),
     &                   LOG_CONSTITUENT(5)
c
     ...
     &                    SNOW_SURFACE,ICE_SURFACE
            if(l_phase) write(16,105) SOIL_SURFACE,WATER_SURFACE,
     &                    SNOW_SURFACE,ICE_SURFACE
            if(l_kappa) write(17,105) SOIL_SURFACE,WATER_SURFACE,
     &                    SNOW_SURFACE,ICE_SURFACE
            if(l_trans) write(18,105) SOIL_SURFACE,WATER_SURFACE,
     &                    SNOW_SURFACE,ICE_SURFACE
            write(19,105) SOIL_SURFACE,WATER_SURFACE,
     &                    SNOW_SURFACE,ICE_SURFACE

c
            write(7,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(8,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(11,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(12,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(13,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(14,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            if(l_pol) write(15,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            if(l_phase)write(16,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            if(l_kappa)write(17,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            if(l_trans)write(18,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
            write(19,107) LOG_EPS_TABLE(1), LOG_EPS_TABLE(2),
     &       LOG_EPS_TABLE(3), LOG_EPS_TABLE(4), LOG_EPS_TABLE(5),
     &       LOG_EPS_TABLE(6)
...
C
            ...
            IF(I_PDF_NDL.EQ.1)THEN
                C_PDF_NDL = '0.5*SIN(Theta_c) - Uniform'
...
c
        if(LOG_EPS_TABLE(6).and.SOIL_SURFACE)then
     ...
     &                   LS_SOIL,c_surf
        else if(LOG_EPS_TABLE(6).and.WATER_SURFACE)then
...
c
100     format(' Trunks = ',L1,', Primary Branches = ',L1,
     &         ', Secondary Branches = ',L1,', Leaves = ',L1,
     &         ', Needles = ',L1)
c
