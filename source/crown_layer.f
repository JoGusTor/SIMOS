...
C
C        COMMON /NDL_EXT/ EXP_KAPPA_NDL_p, EXP_KAPPA_NDL_m
C        COMMON /LEAF_EXT/ EXP_KAPPA_LF_p, EXP_KAPPA_LF_m
C        COMMON /BR1_EXT/ EXP_KAPPA_BR_p, EXP_KAPPA_BR_m
C        COMMON /BR2_EXT/ EXP_KAPPA_BR_p2, EXP_KAPPA_BR_m2
C
C***********************************************************************
