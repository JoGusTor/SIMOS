...
public class Main{
    ...
    public static void main(String[] args) {
       ...
       /* CadModulo p1Suc = new CadModulo();
        ...
        CadModulo p1Suc = new CadModulo();
        p1Suc.agregaModulo(F); //Apex
        p1Suc.agregaModulo(derecha); //Apex
        p1Suc.agregaModulo(abre); //Apex
        p1Suc.agregaModulo(h); //Apex
        p1Suc.agregaModulo(cierra); //Apex
        p1Suc.agregaModulo(izquierda); //Apex
        p1Suc.agregaModulo(izquierda); //Apex
        p1Suc.agregaModulo(abre); //Apex
        p1Suc.agregaModulo(h); //Apex
        p1Suc.agregaModulo(cierra); //Apex
        ...
        p2Suc.agregaModulo(F); //Apex
        p2Suc.agregaModulo(arriba); //Apex
        p2Suc.agregaModulo(abre); //Apex
        ...
        Produccion p1 = new Produccion(w, p1Suc);
         Produccion p2 = new Produccion(h, p2Suc);
