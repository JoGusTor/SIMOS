 ...
 * @author zero
 */
public class dielectric_branch1_table {
        ...
        float epsilon_r1;
        float epsilon_r2;
        public dielectric_branch1_table(int numParametros,float epsilon1[],float epsilon2[],String ruta){
            ...
            escribeDielectricBranch1Table(ruta,cad);
        }
        
        public dielectric_branch1_table(String ruta){
            values = 1;
        ...
        private void escribeDielectricBranch1Table(String archivo,String cadena){
                try{
