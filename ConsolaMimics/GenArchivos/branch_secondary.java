...
public class branch_secondary {
        ...
        DecimalFormat f1=new DecimalFormat("0.0000");
         DecimalFormat ft=new DecimalFormat("0");
            ...
            float pdf_T;
        public branch_secondary(float mg1,float mg2,float mg3,int T1,float rh1,float rh2,float rh3,int T2,float br1, float br2,float br3,int T3,float br4,float br5, float br6,int T4,float br7,float br8, float br9,int T5,float pdf,String ruta){
            mgbrstrt=mg1;
            mgbrstp=mg2;
            mgbrdelt=mg3;
            t1=T1;
            ...
            pdf_T=pdf;
            escribeBranch_Secondary(ruta);       
        }        
            
        public branch_secondary(String ruta){
            mgbrstrt=0.444444f;
            mgbrstp=0.444f;
            mgbrdelt=0.3f;
            t1=0;
        ...
        private void escribeBranch_Secondary(String archivo){
                try{
